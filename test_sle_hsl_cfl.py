...
parser.add_argument('--reduce', default=0, type=int,
                    metavar='t', help='random seed')
parser.add_argument('--graphw', default=1.0, type=float,
                    metavar='t', help='random seed')
parser.add_argument('--gatw', default=1.0, type=float,
                    metavar='t', help='random seed')
parser.add_argument('--vt', default=0, type=int,
                    metavar='t', help='random seed')
...
if args.method == 'base':
    net = embed_net(n_class, no_local='on', gm_pool='on', arch=args.arch, dataset=dataset, plearn=1,
                      stage=23, depth=args.depth, head=args.head, graphw=args.graphw, gatw=args.gatw, whiten=args.whiten)
...
if dataset == 'sysu':
    ...
    print('==> Resuming from checkpoint..')
    model_path = "./sle_hsl_cfl_ckpt/sysu/save_model/sysu_adp_joint_co_nog_ch_nog_sq1_aug_G_erase_0.5_p4_n8_lr_0.1_seed_0_otri_1_stage_23_depth_2_head_4_resume_1_graphw_1.0_gatw_1.0_mricT_3_whiten_1_theta_0.5_aicT_3_lambda1_1.3_best.t"
