...
from model_sle_hsl import embed_net as basline_pcb

from utils import *
from loss import OriTripletLoss,  KLDivLoss, TripletLoss_ADP
...
parser.add_argument('--startE', default=0, type=int, metavar='startE', help='startE for the model')
...
suffix = suffix + '_p{}_n{}_lr_{}_seed_{}_localtri_{}_otri_{}_stage_{}_depth_{}_head_{}_pha_{}_graphw_{}_theta1_{}'.format(
    args.num_pos, args.batch_size,
    args.lr, args.seed, args.localtri, args.otri,
    args.stage, args.depth, args.head, args.pha, args.graphw, args.theta1)
...
net = basline_pcb(n_class, no_local='on', gm_pool='on', arch=args.arch, dataset=dataset, plearn=args.pl,
                      stage=args.stage, depth=args.depth, head=args.head, graphw=args.graphw, theta1=args.theta1)
...
if args.dataset == 'sysu':
    model_path = "./sle_ckpt/sysu/save_model/sysu_adp_joint_co_nog_ch_nog_sq1_aug_G_erase_0.5_p4_n8_lr_0.1_seed_0_localtri_0.0_otri_1_stage_23_depth_2_head_4_pha_1.0_best.t"
